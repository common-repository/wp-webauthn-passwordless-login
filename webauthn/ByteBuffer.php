...
require 'WebAuthnException.php';

class moWebAuthn_ByteBuffer implements \JsonSerializable, \Serializable {
    /**
     * @var bool
     */
    ...
    public static function fromBase64Url($base64url) {
        ...
        return new moWebAuthn_ByteBuffer($bin);
    }
    ...
    public static function randomBuffer($length) {
        if (\function_exists('random_bytes')) { // >PHP 7.0
            return new moWebAuthn_ByteBuffer(\random_bytes($length));

        } else if (\function_exists('openssl_random_pseudo_bytes')) {
            return new moWebAuthn_ByteBuffer(\openssl_random_pseudo_bytes($length));
    ...
    public function jsonSerialize() {
        if (moWebAuthn_ByteBuffer::$useBase64UrlEncoding) {
